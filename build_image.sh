...
check_clone_dependencies() {
  ...
  local dirs=(
    ...
    "replace_file/tools"
    "replace_file/system-sleep"
    "replace_file/backlight"
    "replace_file/pwron-autostop"
    "res"
    "sh"
    "Jason3_Scripte"
  ...
  local files=(
    ...
    "replace_file/system-sleep/zz-arkos4clone-resume"
    "replace_file/backlight/arkos4clone-bl-kick"
    "replace_file/backlight/perfmax"
    "replace_file/backlight/perfnorm"
    "replace_file/pwron-autostop/pwron-autostop.py"
    "replace_file/pwron-autostop/pwron-autostop.service"
